...
// Notification Channel Id is ignored for Android pre O (26).
         ...
         */if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) { // Enables launching app in Wear 2.0 while keeping the old Notification Style behavior.
            val mainAction =
                NotificationCompat.Action.Builder(
        ...
        } else { // Wear 1.+ still functions the same, so we set the main content intent.
